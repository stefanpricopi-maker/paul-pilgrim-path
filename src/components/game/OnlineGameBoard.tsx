          ...
          <div className="xl:col-span-3">
            <GameBoard
              ...
              players={gameState.players.map(p => ({
                ...
                position: p.position,
                money: p.coins,
                character: { name: p.character_name || 'Unknown', description: '', specialAbility: '', avatar: '', avatar_face: '' },
                properties: [],
            ...
            {currentLocation && isMyTurn && currentLocation.type === 'city' && (
              <PropertyActions
                ...
                currentPlayer={{
                  ...
                  character: { name: currentPlayer.character_name || 'Unknown', description: '', specialAbility: '', avatar: '', avatar_face: '' },
                  properties: [],
          ...
          {gameState.players.map((player, index) => (
            <PlayerCard
              ...
              player={{
                ...
                money: player.coins,
                character: { name: player.character_name || 'Unknown', description: '', specialAbility: '', avatar: '', avatar_face: '' },
                properties: [],
                propertyVisits: {},
                color: '#3B82F6',
